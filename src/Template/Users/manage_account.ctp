...
<fieldset>
    ...
    <legend><?= __('Meus dados') ?></legend>
    <?php
        echo $this->Form->input('newPassword', ['label' => 'Nova senha','type' => 'password', 'templateVars' => ['size_element' => '5'], 'placeholder' => 'Nova senha']);

        echo $this->Form->input('passwordConfirm', ['label' => 'Confirmar nova senha', 'type' => 'password', 'templateVars' => ['size_element' => '5'], 'placeholder' => 'Repetir nova senha']);
    ?>
</fieldset>
